...
cmd({  
  ...
  try {  
    ...
    const { data: commitData } = await axios.get("https://api.github.com/repos/shani-kh/Data/commits/main");  
    ...
    const { data: zipData } = await axios.get("https://github.com/shani-kh/Data/archive/main.zip", { responseType: "arraybuffer" });  
